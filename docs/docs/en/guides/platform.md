...
[next paragraph](../#deploy-a-tock-platform-from-the-sources).
```shell
...
[previous paragraph](../platform#deploy-a-tock-platform-without-sources).
```shell
...
As in the [first bot](../studio) guide using the demo platform, you will create a
...
As in the guide [program courses](../api) using the demo platform, you will create a
...
* Create a Kotlin project for example with Maven as indicated in the guide [program courses](../api)
...
>[high availability](../../admin/availability) section of the Tock manual.
