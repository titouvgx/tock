...
If you want, you can skip this step and [deploy a platform with Docker](../platform)
...
* A functional Tock bot (for example following the [first Tock bot](../studio) guide)
