...
[Créer son premier bot avec Tock Studio](../../user/guides.md.md/studio..md) pour un exemple de création 
...
> Le guide [Créer son premier bot avec Tock Studio](../../user/guides.md.md/studio..md) présente 
...
déclarés programmatiquement via [_Bot API_](../dev/bot-api.md.md.md). Pour voir ces derniers, décochez l'option 
...
Rendez-vous dans [Menu _Test_](../../user/studio/test.md.md) pour la suite du manuel utilisateur. 
