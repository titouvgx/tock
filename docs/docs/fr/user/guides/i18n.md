...
(dans _Tock Studio_). Voir [_Le menu Settings_](../../user/guides.md.md/studio.md.md/configuration).

A tout moment dans _Tock Studio_, il est possible de changer la langue sélectionnée dans la bannière en haut de page, 
notamment pour dialoguer avec un bot dans l'interface _Test the bot_. Voir [_Interface générale_](../../user/guides.md.md/studio.md.md/general).
...
Voir [_Le menu Stories & Answers_](../../user/guides.md.md/studio.md.md/stories-and-answers).
...
Le [manuel développeur Tock](../../dev/i18n.md.md) donne plus de détails sur le développement des bots multilingues.
